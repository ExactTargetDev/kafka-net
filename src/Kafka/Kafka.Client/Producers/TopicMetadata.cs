...
namespace Kafka.Client.Producers
{
    ...
    public class TopicMetadata : IWritable
    {
        ...
        public TopicMetadata(string topic, IEnumerable<PartitionMetadata> partitionsMetadata)
        {
            this.Topic = topic;
        ...
        internal static TopicMetadata ParseFrom(KafkaBinaryReader reader)
        {
            ...
            {
                partitionsMetadata.Add(PartitionMetadata.ParseFrom(reader));
            }
            return new TopicMetadata(topic, partitionsMetadata);
        }
    }
}
